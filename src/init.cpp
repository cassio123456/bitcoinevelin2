...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinevelin-project/bitcoinevelin>";
    const std::string URL_WEBSITE = "<https://bitcoinevelin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Bitcoinevelin version %s\n", FormatFullVersion());
}
