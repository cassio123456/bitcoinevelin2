...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinevelin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinevelin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinevelin transaction") + "\n" +
              "  bitcoinevelin-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinevelin transaction") + "\n" +
              "\n";
